  ...
  try {
    ...
    res.json({
      ...
      videoUsage: {
        ...
        limit: planConfig.video_usage_budget_per_month,
        analysesUsed: usage.videoAnalysisRunsUsed ?? usage.videoAnalysesUsed,
        analysesLimit: planConfig.video_analyses_display_limit,
      },
      scriptGenerations: {
        used: usage.scriptGenerationsUsed ?? usage.scriptPlannerChatsUsed,
        limit: planConfig.script_generations_per_month,
      },
      features: planConfig.features,
      limits: {
        video_usage_budget_per_month: planConfig.video_usage_budget_per_month,
        video_analyses_display_limit: planConfig.video_analyses_display_limit,
        script_generations_per_month: planConfig.script_generations_per_month,
