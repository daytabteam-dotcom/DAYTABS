...
const plans = [
  {
    ...
    features: [
      ...
      { text: "Content Growth: 1 week plan + 1 platform (LinkedIn/Instagram/TikTok)" },
      { text: "Content Growth: 3 AI improvements on manual ideas" },
    ] as Feature[],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Content Growth: 2 platforms (LinkedIn/Instagram/TikTok)" },
      { text: "Content Growth: month planning + goal-based next week" },
      { text: "Content Growth: 15 AI improvements + 8 extra AI ideas per platform" },
    ] as Feature[],
    missing: [] as string[],
    cta: "Start Creator",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Content Growth: 3 platforms (LinkedIn/Instagram/TikTok)" },
      { text: "Content Growth: behavior-based weekly planning" },
      { text: "Content Growth: 30 manual ideas + 20 extra AI ideas per platform" },
    ] as Feature[],
    missing: [] as string[],
    cta: "Start Pro",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Content Growth: unlimited AI improvements + extra AI ideas" },
