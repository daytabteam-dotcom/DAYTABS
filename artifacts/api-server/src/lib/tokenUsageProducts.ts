...
export const TOKEN_PRODUCT_AREA_SQL_CASE = `
  CASE
    ...
    WHEN feature IN ('contentCreation', 'scriptPlanner', 'growthPlanner') THEN 'contentPlanner'
...
export function getTokenProductArea(feature: string): TokenProductArea | null {
  ...
  if (feature === "contentCreation" || feature === "scriptPlanner" || feature === "growthPlanner") return "contentPlanner";
