...
const plans = [
  {
    ...
    features: [
      ...
      { text: "1 week Content Growth plan" },
      { text: "1 platform only" },
      { text: "3 AI idea improvements" },
      { text: "No extra AI idea generation" },
    ] as Feature[],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Content Growth: 2 platforms" },
      { text: "Content Growth: monthly planning" },
      { text: "Content Growth: 15 AI improvements per platform" },
      { text: "Content Growth: 8 extra AI ideas per platform" },
      { text: "Content Growth: goal-based next week planning" },
    ] as Feature[],
    missing: [] as string[],
    cta: "Start Creator",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Content Growth: 3 platforms" },
      { text: "Content Growth: behavior-based weekly planning" },
      { text: "Content Growth: 30 AI improvements per platform" },
      { text: "Content Growth: 20 extra AI ideas per platform" },
      { text: "Content Growth: end-of-week performance learning" },
    ] as Feature[],
    missing: [] as string[],
    cta: "Start Pro",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Content Growth: 3 platforms" },
      { text: "Content Growth: behavior-based weekly planning" },
      { text: "Content Growth: unlimited AI improvements" },
      { text: "Content Growth: unlimited extra AI ideas" },
      { text: "Content Growth: end-of-week performance learning" },
